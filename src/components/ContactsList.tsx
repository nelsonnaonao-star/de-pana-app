...
function ContactRow({
  ...
  return (
    ...
    >
      <div className={`w-11 h-11 rounded-[62%_38%_55%_45%/45%_55%_40%_60%] overflow-hidden bg-gradient-to-br ${avatarColors[colorIndex]} shrink-0 shadow-sm flex items-center justify-center`}>
        {contact.avatar ? (
